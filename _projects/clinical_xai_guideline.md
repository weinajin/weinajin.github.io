...
{% include figure.liquid loading="eager" path="assets/img/publication_preview/graphicabstract_XAI_guideline.jpg" class="img-fluid z-depth-1" %}
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/img/clinical_XAI_guideline.png" class="img-fluid z-depth-1" %}
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/publication_preview/Poster_AAAI22_Evaluating_ExplainableAI_Jin_Li_Hamarneh.jpg" class="img-fluid z-depth-1" zoomable=true %}
    </div>
</div>
