...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/publication_preview/card_sorting.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    This is one set of prototyping cards I designed and used in my user study with neurosurgeons. I also designed other similar cards based on the EUCA framework for other medical specialities. 
</div>


<h5>Related Publication</h5>
<div class="publications">
  {% bibliography -f papers -q @*[project=jin2022doctorUserStudy]* %}
</div>